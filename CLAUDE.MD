...
- After task approved use the `@git-expert` agent for suggest branch, commit, and PR output
...
## 10) Task SOP (Mandatory — before start any task and to complete every task)

### 1. Understand

- [ ] I fully understood the requirements before starting.
- [ ] I asked if anything was unclear.

### 2. Implement

- [ ] The code is consistent with business logic.
- [ ] There are no temporary shortcuts.

### 3. Test

- [ ] I personally tested the feature on the device/emulator.
- [ ] I tested the edge cases.
- [ ] I confirmed that other features were not affected.

━━━━━━━━━━━━━━━━━━━━━━

### 4. Notes — To be filled out.
...
- [ ] Business Logic Error — Responsible: Product Owner
- [ ] Coding Error — Responsible: Developer
- [ ] Missing Test Coverage — Responsible: Developer
- [ ] Requirements Unclear — Responsible: Project Manager
- [ ] Regression — Responsible: Whoever created the PR

**If there is a future risk:**
